...
import com.example.mbsarfachruddin.databinding.FragmentTeacherQuranBinding
...
import com.example.mbsarfachruddin.ui.musyrif.home.quran.QuranSurahAdapter
...
class TeacherQuranFragment : Fragment(R.layout.fragment_teacher_quran) {

    private val binding: FragmentTeacherQuranBinding by viewBinding(FragmentTeacherQuranBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with (binding) {
            ...
            surahAdapter.itemClickListener = { data ->
                ...
                findNavController().navigate(R.id.action_teacherQuranFragment_to_teacherQuranDetailFragment, bundle)
            }
