...
class BlogAdapter(private val listBlog: List<com.example.mbsarfachruddin.model.remote.blog.BlogResponseItem>) : RecyclerView.Adapter<BlogAdapter.BlogViewHolder>() {

    var itemClickListener: ((com.example.mbsarfachruddin.model.remote.blog.BlogResponseItem) -> Unit)? = null

    inner class BlogViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding: ItemBlogBinding by viewBinding(ItemBlogBinding::bind)

        fun bindView(blog: com.example.mbsarfachruddin.model.remote.blog.BlogResponseItem) {
