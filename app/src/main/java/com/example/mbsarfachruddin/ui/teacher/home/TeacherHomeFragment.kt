...
import com.example.mbsarfachruddin.databinding.FragmentTeacherHomeBinding
...
import com.example.mbsarfachruddin.ui.musyrif.home.BlogAdapter
...
class TeacherHomeFragment : Fragment(R.layout.fragment_teacher_home) {
    ...
    private val binding: FragmentTeacherHomeBinding by viewBinding(FragmentTeacherHomeBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val response = apiService.getTeacher(userID)

            binding.tvTeacherName.text = response.data.name
            binding.tvTeacherCode.text = response.data.nip
        }

        with(binding) {
            llFtrPresence.setOnClickListener {
                findNavController().navigate(R.id.action_teacherHomeFragment_to_teacherPresenceFragment)
            }

            llFtrQuran.setOnClickListener {
                findNavController().navigate(R.id.action_teacherHomeFragment_to_teacherQuranFragment)
            }

            llFtrPrayerTime.setOnClickListener {
                findNavController().navigate(R.id.action_teacherHomeFragment_to_teacherPrayerTimeFragment)
            }
        }
