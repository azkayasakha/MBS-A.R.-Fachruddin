...
import com.example.mbsarfachruddin.databinding.FragmentMusyrifQuranBinding
...
class MusyrifQuranFragment : Fragment(R.layout.fragment_musyrif_quran) {

    private val binding: FragmentMusyrifQuranBinding by viewBinding(FragmentMusyrifQuranBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with (binding) {
            ...
            surahAdapter.itemClickListener = { data ->
                ...
                findNavController().navigate(R.id.action_musyrifQuranFragment_to_musyrifQuranDetailFragment, bundle)
            }
