...
class AnnouncementAdapter(private val listAnnouncement: List<com.example.mbsarfachruddin.model.remote.announcement.Data>): RecyclerView.Adapter<AnnouncementAdapter.AnnouncementViewHolder>() {
