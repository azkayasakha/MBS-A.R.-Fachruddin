...
class StudentPresenceTahfidzFragment : Fragment(R.layout.fragment_student_presence_tahfidz) {

    private val binding: FragmentStudentPresenceTahfidzBinding by viewBinding(FragmentStudentPresenceTahfidzBinding::bind)
    ...
    private fun loadAttendance(userID: String, month: Int) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val response = apiService.getStudentTahfidzAttendance(userID, month)
            ...
            val adapter = PresenceTahfidzAdapter(response.data)
